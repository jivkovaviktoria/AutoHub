...
namespace AutoHub.Data.Migrations.TestDb
{
    ...
    [Migration("20230418092411_AddedTestDbContext")]
    partial class AddedTestDbContext
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoHub.Data.Models.User", b =>
                {
            ...
            modelBuilder.Entity("AutoHub.Data.Models.Car", b =>
                {
                    b.HasOne("AutoHub.Data.Models.User", "User")
                        .WithMany("Cars")
            ...
            modelBuilder.Entity("CarUser", b =>
                {
                    b.HasOne("AutoHub.Data.Models.Car", null)
                        .WithMany()
                        .HasForeignKey("FavouriteCarsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AutoHub.Data.Models.User", null)
                        .WithMany()
